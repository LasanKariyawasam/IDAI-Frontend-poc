...
export function SignInPage({ onSignIn, onGoSignUp }: SignInProps) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "rgba(255,255,255,0.4)", margin: 0 }}>
          ...
          <span onClick={onGoSignUp} style={{ color: "#b3ff00", fontWeight: 600, cursor: "pointer" }}>
            Sign up
          </span>
        </p>
      </div>
