...
// function EvidenceCard({ label, description }: { label: string; description: string }) {
//   return (
//     <div style={{
//       background: "rgba(255,255,255,0.025)",
//       border: "1px solid rgba(255,255,255,0.07)",
...
//         <h2 style={{ margin: 0, fontSize: 26, fontWeight: 800, letterSpacing: -0.5, color: "#fff" }}>
//           Detection Report
//         </h2>
//         {analysis?.imageType && (
//           <p style={{ margin: "4px 0 0", fontSize: 13, color: "rgba(255,255,255,0.35)" }}>
//             Image Type: <span style={{ color: "rgba(255,255,255,0.65)", fontWeight: 600 }}>
//               {analysis.imageType}
//             </span>
//           </p>
//         )}
//         <p style={{ margin: "4px 0 0", fontSize: 12, color: "rgba(255,255,255,0.25)", fontFamily: "'DM Mono',monospace" }}>
//           {result.originalFilename}
//         </p>
//       </div>

//       {/*TOP CARD: image + score */}
//       <div style={{ display: "grid", gridTemplateColumns: imgSrc ? "1fr 1fr" : "1fr", gap: 14, marginBottom: 16 }}>
//         {imgSrc && (
//           <div style={{
...
//           {/* Forgery score */}
//           <div>
//             <p style={{ margin: "0 0 4px", fontSize: 10, color: "rgba(255,255,255,0.3)", fontFamily: "'DM Mono',monospace", letterSpacing: 1, textTransform: "uppercase" }}>
//               Overall Forgery Score
//             </p>
//             <div style={{ display: "flex", alignItems: "baseline", gap: 1 }}>
//               <span style={{ fontSize: 46, fontWeight: 900, lineHeight: 1, color: scoreColor }}>
//                 {forgeryScore}
//               </span>
//               <span style={{ fontSize: 20, fontWeight: 700, color: scoreColor }}>%</span>
//             </div>
//             <span style={{
//               display: "inline-block", marginTop: 6, fontSize: 11, fontWeight: 600,
//               color: scoreColor, background: `${scoreColor}18`,
//               border: `1px solid ${scoreColor}33`, borderRadius: 999, padding: "2px 10px",
//             }}>
//               {scoreLabel}
//             </span>
//           </div>
...
//           {/* Verdict */}
//           <div>
//             <p style={{ margin: "0 0 5px", fontSize: 10, color: "rgba(255,255,255,0.3)", fontFamily: "'DM Mono',monospace", letterSpacing: 1, textTransform: "uppercase" }}>
//               Verdict
//             </p>
//             <p style={{ margin: "0 0 8px", fontSize: 14, fontWeight: 700, color: isFake ? "#ef4444" : "#22c55e" }}>
//               {isFake ? "⚠️ " : "✅ "}{result.verdict}
//             </p>
//             {analysis?.riskLevel && (
//               <span style={{
//                 fontSize: 11, fontWeight: 600,
//                 color: analysis.riskLevel === "High" ? "#ef4444" : analysis.riskLevel === "Medium" ? "#f59e0b" : "#22c55e",
//                 background: analysis.riskLevel === "High" ? "#ef444418" : analysis.riskLevel === "Medium" ? "#f59e0b18" : "#22c55e18",
//                 border: `1px solid ${analysis.riskLevel === "High" ? "#ef444433" : analysis.riskLevel === "Medium" ? "#f59e0b33" : "#22c55e33"}`,
//                 borderRadius: 999, padding: "2px 10px", display: "inline-block",
//               }}>
//                 {analysis.riskLevel} Risk
//               </span>
//             )}
//             <p style={{ margin: "8px 0 0", fontSize: 11, color: "rgba(255,255,255,0.3)", fontFamily: "'DM Mono',monospace" }}>
//               Model: {result.detectionMethod || "Hive AI"}<br />
//               v{result.modelVersion || "—"} · {result.fileSize}
//             </p>
//           </div>
//         </div>
//       </div>
...
//       {/* ── AUDIO CATEGORY BREAKDOWN (Vocal Consistency etc.) ── */}
...
//           borderRadius: 12, padding: "16px 18px", marginBottom: 16,
//         }}>
//           <p style={{ margin: "0 0 8px", fontSize: 10, color: "rgba(255,255,255,0.3)", fontFamily: "'DM Mono',monospace", textTransform: "uppercase", letterSpacing: 1 }}>
//             Analysis Summary
//           </p>
...
//             <p style={{ margin: "10px 0 0", fontSize: 12, color: "rgba(255,255,255,0.4)", fontStyle: "italic", lineHeight: 1.6 }}>
//               💡 {analysis.recommendation}
//             </p>
//           )}
//         </div>
...
//       {/* ── STRONGEST EVIDENCE SNAPSHOTS ── */}
// {(analysis?.strongestEvidenceSnapshots ?? []).length > 0 && (
//   <div style={{ marginBottom: 16 }}>
...
//       {analysis?.strongestEvidenceSnapshots?.map((e, i) => (
//         <EvidenceCard key={i} label={e.label} description={e.description} />
//       ))}
//     </div>
//   </div>
// )}
...
//       {/* ── FALLBACK: raw signals if no analysis ── */}
...
//               <CategoryCard key={i} category={s.name} score={Math.round(s.score * 100)} explanation="" />
//             ))}
//           </div>
//         </div>
//       )}
...
//       }}>
//         <div style={{
//           fontFamily: "'DM Mono',monospace", fontSize: 11, color: "rgba(255,255,255,0.28)",
//           display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center",
//         }}>
//           <span>{result.originalFilename}</span>
//           <span style={{ color: "rgba(255,255,255,0.12)" }}>·</span>
//           <span>{new Date(result.scanTimestamp).toLocaleString("en-US", {
...
//           <button onClick={() => generatePdfReport(result)} style={{
//             flex: 1, background: "#b3ff00", border: "none", color: "#000",
...
//               border: `1.5px solid ${scanHovered ? "#b3ff00" : "rgba(255,255,255,0.13)"}`,
//               color: scanHovered ? "#b3ff00" : "rgba(255,255,255,0.65)",
//               borderRadius: 999, padding: "11px 20px", fontSize: 13,
...
//         <p style={{ fontSize: 11, color: "rgba(255,255,255,0.18)", fontStyle: "italic", textAlign: "center", margin: 0, lineHeight: 1.6 }}>
